...
jlong Java_com_ione_opustool_OpusJni_opusDecoderCreate(JNIEnv *env, jobject object, jint sampleRate, jint channels) {
	int error;
	OpusDecoder *decoder = opus_decoder_create((opus_int32)sampleRate, (int)channels, &error);
	return (jlong)(intptr_t) decoder;
}

void Java_com_ione_opustool_OpusJni_opusDecoderDestroy(JNIEnv *env, jobject object, jlong decoder) {
	opus_decoder_destroy((OpusDecoder *)(intptr_t)decoder);
}

jint Java_com_ione_opustool_OpusJni_opusDecodeFloat(JNIEnv *env, jobject object, jlong decoderRef, jbyteArray data, jint len, jfloatArray pcm, jint frame_size, jint decode_fec) {
...
jint Java_com_ione_opustool_OpusJni_opusPacketGetFrames(JNIEnv *env, jobject object, jbyteArray data, jint length) {
...
jint Java_com_ione_opustool_OpusJni_opusPacketGetSamplesPerFrame(JNIEnv *env, jobject object, jbyteArray data, jint sampleRate) {
	const unsigned char *dataBytes = (const unsigned char*)env->GetByteArrayElements(data, NULL);
...
jint Java_com_ione_opustool_OpusJni_opusPacketGetChannels(JNIEnv *env, jobject object, jbyteArray data) {
	const unsigned char *dataBytes = (const unsigned char*)env->GetByteArrayElements(data, NULL);
...
jlong Java_com_ione_opustool_OpusJni_opusEncoderCreate(JNIEnv *env, jobject object, jint sampleRate, jint channels, jint application) {
	int error;
...
void Java_com_ione_opustool_OpusJni_opusEncoderDestroy(JNIEnv *env, jobject object, jlong encoder) {
	opus_encoder_destroy((OpusEncoder *)(intptr_t)encoder);
}

jint Java_com_ione_opustool_OpusJni_opusEncode(JNIEnv *env, jobject object, jlong encoderRef, jshortArray pcm, jint frameSize, jbyteArray data, jint maxBytes) {
...
jint Java_com_ione_opustool_OpusJni_opusEncoderCtl(JNIEnv *env, jobject object, jlong encoderRef, jint request, jint value) {
	OpusEncoder *encoder = (OpusEncoder *)(intptr_t)encoderRef;
